...
% Case 2
var_0 = [0 0 -1800 0 0.0278 0 20.99 0 0.5837 0 0 0]'; 
...
ode_func1 = @(time,aircraft_state) AircraftEOMDoublet(time, var_0, aircraft_surfaces, doublet_size, ...
...
%% 3.3
% tspan = 0:0.1:100;
% ode_func2 = @(time,aircraft_state) AircraftEOMDoublet(time, var_0, aircraft_surfaces, doublet_size, ...
%     doublet_time, wind_inertial, aircraft_parameters);
